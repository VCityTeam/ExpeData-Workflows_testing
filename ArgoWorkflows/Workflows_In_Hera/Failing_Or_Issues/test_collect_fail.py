...
# Required for finding environment.py
sys.path.append(os.path.join(os.path.dirname(__file__), ".."))
# Required e.g. for input_2012_tiny_import_dump
sys.path.append(
    os.path.join(os.path.dirname(__file__), "..", "CityGMLto3DTiles_Example/")
)

####
# The following workflow is expected to FAIL (it is not expected to run): refer
# to the comments below for an explanations on the reasons for this failure.
####
